public abstract class EnemyShip {
    ...
    // Newly defined objects that represent weapon & engine. These can be changed easily by assigning new parts   in
    // UFOEnemyShipFactory or UFOBossEnemyShipFactory.
    ESWeapon weapon;
    ESEngine engine;
